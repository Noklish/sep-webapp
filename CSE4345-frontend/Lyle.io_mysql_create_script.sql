...
Insert into Posts (userName, title, body, forumID) values ("JSmith", "Encryption","I need to figure out how to encrypt this data for homework",2);
Insert into Posts (userName, title, body, forumID) values ("NSchweser", "Best game engine?","Unity or Unreal? Please help me decide I am very poor",3);
Insert into Posts (userName, title, body, forumID) values ("NSchweser", "Come to Cyber Security Club!","It's gonna be great, I really think you'll enjoy it!",2);
